...
namespace CoreDBModel.Migrations
{
    ...
    [Migration("20260202141345_BoundedFreeLessonsToAbonements")]
    partial class BoundedFreeLessonsToAbonements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreDBModel.Models.AbonementShedule", b =>
                {
                    ...
                    b.Property<int?>("TeacherSheduleId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreDBModel.Models.AbonementShedule", b =>
                {
                    ...
                    b.HasOne("CoreDBModel.Models.TeacherShedule", null)
                        .WithOne("AbonementShedule")
                        .HasForeignKey("CoreDBModel.Models.AbonementShedule", "TeacherSheduleId1");
