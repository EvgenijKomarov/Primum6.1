...
namespace CoreDBModel.Migrations
{
    ...
    [Migration("20260913054615_Added-Consultation-Requests")]
    partial class AddedConsultationRequests
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoreDBModel.Models.Abonement", b =>
                {
                    ...
                    b.Property<int>("CancelledLessons")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("CoreDBModel.Models.User", b =>
                {
                    ...
                    b.Property<TimeSpan>("TimeZoneOffset")
                        ...
                        .HasDefaultValue(new TimeSpan(0, 3, 0, 0, 0));
